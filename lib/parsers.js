...
export async function parsePdf(buffer) {
  ...
  // pdf-parse bundles an old pdf.js that reads object offsets against the
  // underlying ArrayBuffer while IGNORING a Buffer's byteOffset. Node pools
  // small Buffers (giving them a nonzero byteOffset), which shifts every xref
  // offset and throws "bad XRef entry". Copy into a standalone, byteOffset-0
  // typed array so parsing is reliable regardless of how the buffer was made.
